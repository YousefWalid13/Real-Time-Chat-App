...
// Sidebar is always 280px wide — the parent in ChatPage handles
// whether it's in-flow (desktop) or a fixed drawer (mobile).
export default function Sidebar({
  ...
  const [confirmDestroyRoom, setConfirmDestroyRoom] = useState(null);
  ...
  return (
    <div
      style={{
        ...
        height: "100%",
        flexShrink: 0,
        // Prevent sidebar content from ever overflowing its 280px box
        overflowX: "hidden",
      }}
    >
      {/* ── Header ── */}
        ...
        >
          ...
          >
            ...
            >
              ...
              will be permanently deleted with all its messages. This cannot be
              undone.
            </div>
